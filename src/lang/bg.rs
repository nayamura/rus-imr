...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Свързване с Remo-IMR мрежата..."),
        ...
        ("install_tip", "Поради UAC, Remo-IMR в някои случай не може да работи правилно за отдалечена достъп. За да заобиколите UAC, моля, натиснете копчето по-долу, за да поставите Remo-IMR като системна услуга."),
        ("Click to upgrade", "Натиснете, за да надстроите"),
        ("Configure", "Настройване"),
        ("config_acc", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на Remo-IMR права от раздел \"Достъпност\"."),
        ("config_screen", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на Remo-IMR права от раздел \"Запис на екрана\"."),
        ...
        ("Discovered", "Открит"),
        ("install_daemon_tip", "За зареждане при стартиране на ОС трябва да инсталирате Remo-IMR като системна услуга."),
        ...
        ("android_input_permission_tip1", "За да може отдалечено устройство да управлява вашето Android устройство чрез мишка или допир, трябва да разрешите на Remo-IMR да използва услугата \"Достъпност\"."),
        ("android_input_permission_tip2", "Моля, отидете на следващата страница със системни настройки, намерете и въведете [Installed Services], включете услугата [Remo-IMR Input]."),
        ...
        ("Language", "Език"),
        ("Keep Remo-IMR background service", "Запази Remo-IMR фоновата услуга"),
        ("Ignore Battery Optimizations", "Игнорирай оптимизациите на батерията"),
        ("android_open_battery_optimizations_tip", "Ако искате да деактивирате тази функция, моля, отидете на следващата страница с настройки на приложението Remo-IMR, намерете и въведете [Battery], премахнете отметката от [Unrestricted]"),
        ...
        ("config_input", "За да управлявате отдалечена среда с клавиатура, трябва да предоставите на Remo-IMR право за \"Input Monitoring\"."),
        ("config_microphone", "За да говорите отдалечено, трябва да предоставите на Remo-IMR право за \"Запис на звук\"."),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да натисне върху OK в прозореца на UAC при стартиран Remo-IMR."),
        ...
        ("verify_rustdesk_password_tip", "Проверете Remo-IMR паролата"),
        ...
        ("scam_text1", "Ако разговаряте по телефона с някой, когото НЕ ПОЗНАВАТЕ и НЯМАТЕ ДОВЕРИЕ, който ви е помолил да използвате Remo-IMR и да стартирате услугата, не продължавайте и затворете незабавно."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Моля обновете Remo-IMR Server Pro на версия {} или по-нова!"),
        ...
        ("selinux_tip", "SELinux е активиран на вашето устройство, което може да попречи на Remo-IMR да работи правилно като контролирана страна."),
        ...
        ("powered_by_me", "Работи с Remo-IMR"),
        ...
        ("allow-only-conn-window-open-tip", "Разрешаване на връзка само ако прозорецът на Remo-IMR е отворен"),
        ...
        ("floating_window_tip", "Помага за поддържане на фоновата услуга на Remo-IMR"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Моля, надстройте клиента Remo-IMR до версия {} или по-нова от отдалечената страна!"),
        ...
        ("allow-insecure-tls-fallback-tip", "По подразбиране Remo-IMR проверява сертификата на сървъра за протоколи, използващи TLS.\nКогато тази опция е активирана, Remo-IMR ще пропусне стъпката на проверка и ще продължи в случай на неуспешна проверка."),
        ("Disable UDP", "Забрана на UDP"),
        ("disable-udp-tip", "Управлява дали да се използва само TCP.\nКогато тази опция е активирана, Remo-IMR вече няма да използва UDP 21116, а вместо това ще се използва TCP 21116."),
        ("server-oss-not-support-tip", "ЗАБЕЛЕЖКА: Remo-IMR server OSS не включва тази функция."),
