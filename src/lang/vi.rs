...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới Remo-IMR..."),
        ...
        ("install_tip", "Do cơ chế UAC, Remo-IMR có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt Remo-IMR vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho Remo-IMR."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho Remo-IMR."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [Remo-IMR Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep Remo-IMR background service", "Giữ dịch vụ Remo-IMR chạy nền"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu Remo-IMR"),
        ...
        ("scam_text2", "Chỉ sử dụng Remo-IMR với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ Remo-IMR mở"),
        ...
        ("floating_window_tip", "Giữ Remo-IMR trên cùng"),
