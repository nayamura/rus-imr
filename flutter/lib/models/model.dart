...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsRemo-IMRVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsRemo-IMRVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsRemo-IMRVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get Remo-IMRVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsRemo-IMRVirtualDisplays] ?? []);
